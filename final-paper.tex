...
\begin{document}
    ...
    \begin{figure}[H]
        \centering
        \subfloat[\centering Training Report]{{\includegraphics[width=7.5cm]{mlr-class-report-train.png} }}
        \qquad
        \subfloat[\centering Testing Report]{{\includegraphics[width=7.5cm]{mlr-class-report-test.png} }}
    ...
    \begin{figure}[H]
        \centering
        \subfloat[\centering Training Report]{{\includegraphics[width=7.5cm]{svm-class-report-train.png} }}
        \qquad
        \subfloat[\centering Testing Report]{{\includegraphics[width=7.5cm]{svm-class-report-test.png} }}
